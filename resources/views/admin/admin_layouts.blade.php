            ...
            <ul class="nav navbar-nav align-items-center ms-auto">
                <li class="nav-item dropdown dropdown-language"><a class="nav-link dropdown-toggle" id="dropdown-flag"
                        href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i
                            class="flag-icon flag-icon-nigeria"></i><span
                            class="selected-language">{{ $userstate->name }}</span></a>
                </li>
            ...
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="/"><i
                    ...
                    <ul class="menu-content">
                        <li><a class="d-flex align-items-center" href={{ URL::to('/admin/dashboard') }}><i
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="/"><i
                            data-feather="home"></i><span class="menu-title text-truncate"
                            data-i18n="Dashboards">Owners</span></a>
                    <ul class="menu-content">
                        <li><a class="d-flex align-items-center" href={{ URL::to('/admin/owner/all') }}><i
                                    data-feather="circle"></i><span class="menu-item text-truncate"
                                    data-i18n="Analytics">All Owners</span></a>
                        </li>
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="/"><i
                            data-feather="home"></i><span class="menu-title text-truncate"
                            data-i18n="Dashboards">Dealers</span></a>
                    <ul class="menu-content">
                        <li><a class="d-flex align-items-center" href={{ URL::to('/admin/dealer/all') }}><i
                                    data-feather="circle"></i><span class="menu-item text-truncate"
                                    data-i18n="Analytics">All Dealers</span></a>
                        </li>
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="/"><i
                            data-feather="home"></i><span class="menu-title text-truncate"
                            data-i18n="Dashboards">Vehicles</span></a>
                    <ul class="menu-content">
                        <li><a class="d-flex align-items-center" href={{ URL::to('/admin/vehicle/all') }}><i
                                    data-feather="circle"></i><span class="menu-item text-truncate"
                                    data-i18n="Analytics">All Vehicles</span></a>
                        </li>
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="/"><i
                            data-feather="home"></i><span class="menu-title text-truncate"
                            data-i18n="Dashboards">Certificates</span></a>
                    <ul class="menu-content">
                        <li><a class="d-flex align-items-center" href={{ URL::to('/admin/certificate/all') }}><i
                                    data-feather="circle"></i><span class="menu-item text-truncate"
                                    data-i18n="Analytics">All Certificates</span></a>
                        </li>
 ...
 --}}
    ...
    <footer class="footer footer-static footer-light">
        <p class="clearfix mb-0"><span class="float-md-start d-block d-md-inline-block mt-25">COPYRIGHT &copy; 2022<a
                    class="ms-25" href="#" target="_blank">JPMB Technologies</a><span
